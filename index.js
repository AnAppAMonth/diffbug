...
/**
 * Provides access to the key libraries in diffbug so you can write
 * your own tools using `diffbug` as a library.
 *
 * @module diffbug
 */
...
/**
 * the top-level API for `diffbug`.
 *
 * Usage
 * -----
 *
 *      var diffbug = require('diffbug');
 *
 *
 * @class API
 */
