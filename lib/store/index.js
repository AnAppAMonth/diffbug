 ...
 * original source, instrumented source, trace objects against file names).
 * This class is both the base class as well as a factory for `Store` implementations.
 *
 * Usage
 * -----
 *
 *      var Store = require('diffbug').Store,
 ...
 * @constructor
 * @protected
 * @param {Object} [options] - The options supported by a specific store implementation.
 */
